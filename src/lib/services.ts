export type Service = {
  /** URL slug for the service's own page, e.g. "corporate-event-styling". */
  slug: string;
  title: string;
  blurb: string;
  detail: string;
...
export const services: Service[] = [
  {
    slug: "corporate-executive-event-styling",
  ...
  {
    slug: "model-home-styling",
    title: "Model Home Styling",
    blurb: "Model homes buyers fall in love with the moment they walk in.",
    detail:
      "For builders and developers, room-by-room styling direction, furnishing concepts, and finished presentation that turn a model home into the reason a community sells. Fly Girl is a true one-stop engagement: we design every room, procure furnishings on your behalf through our trade partnerships, and install a complete, finished presentation. You approve one vision and receive one turnkey result.",
  ...
  },
  {
    ...
    detail:
      "For homeowners, Realtors, and builders preparing homes for market, staging that helps buyers picture the life they want, not just the house in front of them. Every staging is fully furnished through our curated rental collections and finished with accessories, art, and styling details from the Fly Girl inventory, delivered, installed, and styled as one complete service.",
    cta: "Start Your Project",
  },
  {
